...
const ProfileSection = () => {
    ...
    /**
     * anchorRef is used on different componets and specifying one type leads to misc components throwing an error
     * */
                        ...
                        <Paper>
                            <ClickAwayListener onClickAway={handleClose}>
                                <MainCard border={false} elevation={16} content={false} boxShadow shadow={theme.shadows[16]}>
                                    ...
                                    <Divider />
                                    <Box sx={{ p: 2 }}>
                                        <Typography variant="subtitle">TODO: User Profile Info</Typography>
                                    </Box>
                                    ...
                                    <Box sx={{ p: 1 }}>
                                        ...
                                        >
                                            <ListItemButton
                                                ...
                                                onClick={(event) => handleListItemClick(event, 0, "/app/prefs")}
                                            >
                                                <ListItemIcon>
